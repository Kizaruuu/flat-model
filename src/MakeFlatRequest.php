...
class MakeFlatRequest extends BaseCommand
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $res = $this->creatRequest($request, $entity);
     ...
     * @throws Exception
     */
    public function creatRequest(string $request, string $entity = null)
    {
        $request = array_map('ucfirst', array_filter(preg_split('/[^a-z0-9]/i', $request)));
        $requestName = $this->getClassName(array_pop($request)) . 'Request';
...
//        $requestClass = $namespace . '\\' . $requestName;
